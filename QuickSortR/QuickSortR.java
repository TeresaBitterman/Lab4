...
public class QuickSortR {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Before sorting using QuickSortR function");
        System.out.println(java.util.Arrays.toString(testList));
        quickSortR(testList);
        System.out.println("After sorting using QuickSortR function");
        System.out.println(java.util.Arrays.toString(testList));
        System.out.println("-----------------------------");

        System.out.println("Experiment 1 working...");
        runFullExperiment("QuickSortR-Exp1-ThrowAway.txt");
        System.out.println("Experiment 2 working...");
        runFullExperiment("QuickSortR-Exp2.txt");
        System.out.println("Experiment 3 working...");
        runFullExperiment("QuickSortR-Exp3.txt");
    ...
    static void runFullExperiment(String resultsFileName){
        ...
        for(int inputSize=MININPUTSIZE;inputSize<=MAXINPUTSIZE; inputSize*=2) {
            ...
            for (long trial = 0; trial < numberOfTrials; trial++) {
                ...
                long[] foundIndex = quickSortR(testList);
    ...
    public static long[] quickSortR(long[] list)
    {
    ...
    public static long[] quickSortWorker(long[] list, int lo, int hi)
    {
        if(lo >= hi)
        {
            ...
            long pivot = list[lo];
            int pivotIndex = randomBetween(list, lo, hi);
            int nextHi = hi;
    ...
    public static int randomBetween(long[] list, int lo, int hi)
    {
